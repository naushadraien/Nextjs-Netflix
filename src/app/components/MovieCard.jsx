...
const MovieCard = (curElem) => { //this curElem is passed from movie file page.jsx as props
    const {id, title, synopsis, backgroundImage} = curElem.jawSummary; //destructuring the props i.e curElem is titles and this curElem.jawsummary is titles.jawSummary and extracting id, title, synopsis, backgroundImage from jawSummary
  return (
    <>
